"""Evaluation charts for the trained stack.

Reads the per-slot predictions saved by `train.py` (artifacts/model/pred_test.parquet)
...
Run:  python -m modeling.evaluate            
      python -m modeling.evaluate --split val
"""
