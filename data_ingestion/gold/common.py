"""Shared config & IO for the Gold (feature store) layer.
"""
...
from ..silver.common import SILVER_LOCAL_DIR, read_silver  # noqa: F401
...
TS = "timestamp_utc"
# representative UK point for solar geometry (NWP grid origin)
